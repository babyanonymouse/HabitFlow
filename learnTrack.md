...
| Concept / Skill | What to Learn | How to Practice in HabitFlow | Status |
|---|---|---|---|
| Next.js API Routes | /pages/api/* endpoints | Create /api/tasks and /api/habits | ⬜ |
| RESTful CRUD | GET, POST, PUT, DELETE | Implement full task/habit lifecycle | ⬜ |
| Validation | Input validation | Check form inputs server-side | ⬜ |
...
| Concept / Skill | What to Learn | How to Practice in HabitFlow | Status |
|---|---|---|---|
| API Consumption | Axios or fetch | Call /api/tasks from frontend | ⬜ |
...
| M2 | CRUD API | /api/tasks + /api/habits | ⬜ |
...
| M7 | Deployment | Vercel / Render live app | ⬜ |
